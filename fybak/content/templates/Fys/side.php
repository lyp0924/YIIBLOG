...
<?php if($userhide==1):?>
<div class="widget widget-tops wow zoomIn affix-top" style="visibility: visible; animation-name: zoomIn; top: 0px;">
	<ul class="widget-nav">
	...
	<ul class="widget-navcontent">
		...
		<li class="item item-01">
					<ul>
						<?php f162_istop('all','5');?>			
					</ul>
		</li>
		<li class="item item-04">
          <h2>遇到疑问,可以联系我或给我留言</h2>	
			<a class="btn btn-success sns-wechat" href="javascript:;" title="关注”会飞的鱼“" data-src="http://0d077ef9e74d8.cdn.sohucs.com/qzM05EE_png"><i class="fa fa-weixin"></i> 公众号</a> 
			<a target="_blank" class="btn btn-info" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $nexqq; ?>&site=qq&menu=yes"><i class="fa fa-qq"></i> QQ联系</a>								
		</li>	
		</ul>
	</ul>
</div>
