...
<li><a href="<?php echo $value['url']; ?>" target="_blank"><?php echo $value['link']; ?></a></li>
        ...
        <a href="http://www.miibeian.gov.cn" target="_blank"><?php echo $icp; ?></a>	</div>
			<p>Powered by <a href="http://www.emlog.net" target="_blank">Emlog</a> · Theme by <a href="http://www.f162.cn" target="_blank">FYS/会飞的鱼</a></span></p>
			</div>

</footer>
<?php if($logid){?>
<link href="<?php echo TEMPLATE_URL; ?>highslide/highslide.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<?php echo TEMPLATE_URL; ?>highslide/highslide.js"></script>
<script type="text/javascript">
    hs.graphicsDir = "<?php echo TEMPLATE_URL; ?>highslide/graphics/";
