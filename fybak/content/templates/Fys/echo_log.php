...
<section class="container">
	...
	<div class="content">
				<header class="article-header wow zoomIn">
			<h1 class="article-title"><a href="<?php echo $log_url; ?>"><?php topflg($top); ?><?php echo $log_title; ?></a></h1>
...
$(function() {
	...
	<a rel="nofollow" style="color: #fff" class="outbox action-rewards btn-danger" title="打赏，支持一下"><i class="fa fa-heart"></i> 打赏作者</a>
		...
		<div class="asb-post-footer wow zoomIn"><?php if($nrads==1):?><b>AD：</b><strong>【站长推荐】</strong><a target="_blank" href="<?php echo $nrurl; ?>"><?php echo $nrbt; ?></a><?php endif;?></div>	<br>		  
	...
	<div class="article-author wow fadeInUp">
		<img src="<?php global $CACHE;$user_cache = $CACHE->readCache('user');if($user_cache[1]['photo']['src']){echo BLOG_URL.$user_cache[1]['photo']['src'];}else{echo TEMPLATE_URL.'img/avatar.png';}?>" class="avatar" width="40" height="40">	<h4> <i class="fa fa-user" aria-hidden="true"></i>
...
<?php include View::getView('side_page'); ?>
</div>
<?php
