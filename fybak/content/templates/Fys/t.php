...
<?php 
    ...
    ?>
<li class="twiter_list"><section class="comments"><article class="comment"><a class="comment-img" href="#non"><img src="<?php echo $avatar; ?>" alt="fys 1.0 大前端二次开发" width="50" height="50"></a> <div class="comment-body"><div class="text"><p><?php echo comment2emoji($val['t']).'<br/>'.$img;?></p><p class="twiter_info"><i class="fa fa-user"></i><span class="twiter_author"><?php echo $author; ?></span><time class="twiter_time"><i class="fa fa-clock-o"></i> <?php echo $val['date'];?></time></p></div></div></article></section></li>
<?php endforeach;?>
</ul>
<div class="twwiter">
