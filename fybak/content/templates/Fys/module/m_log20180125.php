...
<div class="content-wrap">
	...
	<div id="focusslide" class="carousel slide wow zoomIn" data-ride="carousel">
		...
		<?php }?>
		<?php if(blog_tool_ishome()&& $newsj==2){?>
		...
		<div class="wow fadeInUp">
			...
			<?php echo $Sortp1;?>
						...
						<a class="btn btn-default btn-sm" href="<?php echo $Sorta1;?>">点击进入</a>
						</li>
			...
			<?php echo $Sortp2;?>
						...
						<a class="btn btn-default btn-sm" href="<?php echo $Sorta2;?>" target="_black">点击进入</a>
						</li>
			...
			<?php echo $Sortp3;?>
						...
						<a class="btn btn-default btn-sm" href="<?php echo $Sorta3;?>">点击进入</a>
						</li>
			...
			<?php echo $Sortp4;?>
						...
						<a class="btn btn-default btn-sm" href="<?php echo $Sorta4;?>">点击进入</a>
						</li>
    		...
    		<?php echo $Sortp5;?>
						...
						<a class="btn btn-sm btn-danger" href="<?php echo $Sorta5;?>" target="_black">点击进入</a>
						</li>
					</ul>
				</div>
			</div>
