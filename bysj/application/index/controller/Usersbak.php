    ...
    */
    ...
    public function saveEditUser()
    {
        ...
        if (input("post.user_pro") != ''){
            $user->user_pro = input("post.user_pro");
            $user->user_col = input("post.user_col");
            $user->role_id = input("post.role_id");
        }

        $user->user_id = input("post.user_id");
        $user->user_pho = input("post.user_pho");
        $user->user_name = input("post.user_name");
        $flag = $user->isUpdate()->save();
    ...
    public function savePwd(){
        ...
        $usermsg->user_password = md5(md5($usermsg->user_password).$usermsg->addtime);
